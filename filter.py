...
def remove_returns(transactions, no_returns):
	# Memory error on full transaction list
	unreturned = transactions[transactions.quantity > 0]
	print(str(no_returns) + " returned items removed from transactions. \n")
	return unreturned